...
function squareRootsTests() {
    ...
    //квадратное уравнение  ax2 + bx + c = 0, a не должно быть равно 0, 
    //получается что с данными аргументами это не квадратное уравнение, в нем не надо считать дискриминант и т.д.
}
...
function ttt() {
    ...
    if (!roots.length) { //0=false, !0=true [].length пустого массива =0. 0 один из 5 символов которые дают false (0 '' NaN null undefined), поэтому ставим !0, чтобы для if было условие true 
        alert('корней нет!');
